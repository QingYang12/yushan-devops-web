...
import { gethandApi } from '@/api/common'
import { ref } from 'vue'
...
const gethandApi1 = async () => {
  try {
    const res = await gethandApi('hand0001')
    console.log('【res】：', res)
  } catch (error) {
    console.log('【error】：', error)
  }
...
<template>
  <ContentWrap :title="t('router.request')">
    ...
    <BaseButton type="primary" @click="gethandApi1">测试请求后台</BaseButton>
